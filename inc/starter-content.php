 ...
 *
 * Passes it through the `Dudley_starter_content` filter before returning.
 *
 * @since Dudley 1.0
 *
 * @return array A filtered array of args for the starter_content.
 */
function Dudley_get_starter_content() {
		...
		'posts'     => array(
			'front' => array(
				...
				'post_content' => '
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Dudley includes stylish borders for your content. With an Image block selected, open the "Styles" panel within the Editor sidebar. Select the "Frame" block style to activate it.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Dudley also includes an overlap style for column blocks. With a Columns block selected, open the "Styles" panel within the Editor sidebar. Choose the "Overlap" block style to try it out.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
	 ...
	 */
	return apply_filters( 'Dudley_starter_content', $starter_content );
}
