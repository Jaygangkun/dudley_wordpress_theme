...
<section class="section-story-hero">
	<div class="container-md">
		<h1 class="story-hero-title fs-50"><span class="text-highlight">At Dudley & Co</span>, we're <span class="f-italic">mad about dogs.</span> In fact, we love our dog so much we named the company after him.</h1>
	</div>
</section>
<section class="section-story-content">
	...
	<div class="container-md">
		...
		<div class="section-story-content-imgs">
			<div class="section-story-content-img-col">
				<img class="w-100" src="<?php echo get_template_directory_uri()?>/assets/images/ourstory-img2.png">
			</div>
			<div class="section-story-content-img-col">
				<img class="w-100" src="<?php echo get_template_directory_uri()?>/assets/images/ourstory-img3.png">
			</div>
		</div>
...
<section class="section-story-tasks">
	<div class="container-lg">
		<h1 class="fs-50 section-story-tasks-title"><span class="text-highlight">Luxury that lasts</span></h1>
		<div class="section-story-tasks-list">
			<div class="section-story-task-col">
				<div class="section-story-task-img" style="background-image:url(<?php echo get_template_directory_uri()?>/assets/images/story-task-img1.png)"></div>
				<h6 class="section-story-task-title">✓ Putting Dogs First</h6>
				<p class="section-story-task-desc">Dudley & Co's products are designed with dogs in mind. Our fabrics and fasteners are built tough but with luxury in mind - your dog's comfort is always paramount. </p>
			</div>
			<div class="section-story-task-col">
				<div class="section-story-task-img" style="background-image:url(<?php echo get_template_directory_uri()?>/assets/images/story-task-img2.png)"></div>
				<h6 class="section-story-task-title">✓ A Family Affair</h6>
				<p class="section-story-task-desc">Our products come from the heart. Dudley & Co is named after our in-house pooch, while our signature coat is in loving memory of Rizzo, a London Vizsla from Notting Hill who inspired our dream. We aim to name future clothing after our customers' dogs as they join the family.</p>
			</div>
			<div class="section-story-task-col">
				<div class="section-story-task-img" style="background-image:url(<?php echo get_template_directory_uri()?>/assets/images/story-task-img3.png)"></div>
				<h6 class="section-story-task-title">✓ Doggie Do-Gooders</h6>
				<p class="section-story-task-desc">At Dudley & Co we care deeply about our four-legged friends. A share of our profits will go to independent dog charities on both sides of the Atlantic.</p>
			</div>
		</div>
	</div>
</section>
