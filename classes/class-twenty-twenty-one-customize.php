...
if ( ! class_exists( 'Dudley_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Dudley 1.0
	 */
	class Dudley_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->register_control_type( 'Dudley_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Dudley_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
